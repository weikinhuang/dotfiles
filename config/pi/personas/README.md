...
- [./waveform-overlay-authoring.md](./waveform-overlay-authoring.md) - authoring guide for the voice-only overlay
  personas loaded by [`../extensions/waveform-indicator.md`](../extensions/waveform-indicator.md). Different contract
  from the work personas above; minimum 4B tiny-model floor.
