...
| [`skills/hooks-author/SKILL.md`](./skills/hooks-author/SKILL.md)                     | [`hooks`](./extensions/hooks.md)                                                                                                       | WHEN to wire a user hook (`~/.pi/hooks.json`) vs an ad-hoc command vs a full extension.            |
