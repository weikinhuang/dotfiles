...
- `pi-tmux-smoke` - invoke (`/skill:pi-tmux-smoke`) when smoke-testing pi's interactive TUI (real `/compact`, slash
  commands, overlays) by driving it in a tmux pane.
...
| [`skills/feature-eval-author/SKILL.md`](./skills/feature-eval-author/SKILL.md)               | [`memory`](./extensions/memory.md), [`todo`](./extensions/todo.md), [`scratchpad`](./extensions/scratchpad.md)                         | HOW to build a behavioral eval (SDK headless, small model) measuring whether a feature is READ vs ACTED on; harness + gotchas.      |
...
| [`skills/pi-tmux-smoke/SKILL.md`](./skills/pi-tmux-smoke/SKILL.md)                           | - (drives the `pi` TUI)                                                                                                                | HOW to drive pi's interactive TUI in a tmux pane (send-keys / capture-pane, real `/compact`) for interactive-only smoke tests.      |
