...
import { type ModeThinkingLevel } from './parse.ts';

export { type ModeThinkingLevel } from './parse.ts';
...
export interface SnapshotApi {
  ...
  getThinkingLevel(): ModeThinkingLevel | undefined;
  setThinkingLevel(level: ModeThinkingLevel | undefined): void;
