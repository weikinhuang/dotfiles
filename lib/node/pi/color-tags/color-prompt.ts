...
export function buildColorPromptAddendum(options: BuildColorPromptOptions): string {
  ...
  return [
    ...
    'Rules:',
    '',
    '- Always close with `[/c]` on the SAME line as its open. A span',
    '  never crosses a line break, and an unclosed open is left visible',
    '  as a literal `[c:NAME]` tag on its line - it will not bleed color',
