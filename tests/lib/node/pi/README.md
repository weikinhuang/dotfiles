...
| [`subdir-agents.spec.ts`](./subdir-agents.spec.ts)           | `candidateContextPaths`, `capContent`, `displayPath`, `formatContextInjection`, `isInsideCwd`, `normalizeAbs` from [`subdir-agents.ts`](../../../../lib/node/pi/subdir-agents.ts)                  |
