...
import { type ModeWarning, parseModeFile, type ParseModeOptions } from '../../../../../lib/node/pi/mode/parse.ts';

const KNOWN_TOOLS = new Set(['read', 'write', 'edit', 'bash', 'grep']);

function makeParser(frontmatter: Record<string, unknown>, body = ''): ParseModeOptions['parseFrontmatter'] {
...
): { result: ReturnType<typeof parseModeFile>; warnings: ModeWarning[] } {
