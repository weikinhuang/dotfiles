...
These are tools from external projects that are included in this repo for convenience. Prefer updating them from upstream instead of editing the vendored copies directly.
...
- [`dircolors.solarized.ansi-light`](./dircolors.solarized.ansi-light) is vendored alongside the upstream theme set but is not currently referenced by the repo.
- See the [Solarized homepage](https://ethanschoonover.com/solarized/) for screenshots, details, and related theme ports.
