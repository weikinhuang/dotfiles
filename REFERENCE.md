...
| `AI_SKILL_EVAL_DRIVER`         | [`ai-skill-eval`](./dotenv/bin/ai-skill-eval)                                                                                        | default driver when `--driver` is unset; `pi` or `claude` (auto-detected from `$PATH` if unset)                                           |
