...
| ------------------------------------------------------------- | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`ai-fetch-web`](./dotenv/bin/ai-fetch-web)                   | all               | harness-agnostic CLI for the [`fetch_web`](https://github.com/modelcontextprotocol/servers) MCP server (search, fetch, convert, extract, screenshot, ...); speaks MCP JSON-RPC over HTTPS, configured via `AI_FETCH_WEB_URL` + `AI_FETCH_WEB_AUTH` (falls back to `~/.pi/agent/mcp.json`); pairs with [`config/pi/skills/ai-fetch-web/SKILL.md`](./config/pi/skills/ai-fetch-web/SKILL.md) |
...
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------- |
| `AI_FETCH_WEB_URL`             | [`ai-fetch-web`](./dotenv/bin/ai-fetch-web)                                                                                          | MCP endpoint URL; falls back to the `fetch_web` HTTP server in `~/.pi/agent/mcp.json` when unset                                          |
